...
public class VerticalFlowLayout implements LayoutManager,java.io.Serializable
{
	 ...
	 * distributes empty space for the Java 2 platform, v1.2 and greater. It
	 ...
	 * alignment and a default 5-unit horizontal and vertical gap. The value
	 * of the alignment argument must be one of
	...
	/**
	 * Gets the horizontal gap between components and between the components
	...
	/**
	 * Sets the horizontal gap between components and between the components
	 * and the borders of the <code>Container</code>.
	 * 
	 * @param hgap
	 *              the horizontal gap between components and between the
	...
	// - 1 for version >= Java 2 platform v1.2, which includes "newAlign"
	// field
	//
	 ...
	 * written by older versions of the class that didn't contain all of the
	 * fields we use now..
	 */
	private void readObject(ObjectInputStream stream) throws IOException,ClassNotFoundException
	{
		...
		{
			// "newAlign" field wasn't present, so use the old "align"
			// field.
